...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/travel/flighty/internal/cli"
	mcptools "github.com/mvanhorn/printing-press-library/library/travel/flighty/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("FLIGHTY_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "flighty-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
