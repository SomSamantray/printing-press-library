...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"mcpmarket-pp-cli auth login",
		"mcpmarket-pp-cli doctor",
		"mcpmarket-pp-cli help items",
		"mcpmarket-pp-cli sync",
		"mcpmarket-pp-cli profile list",
		"mcpmarket-pp-cli feedback list",
		"mcpmarket-pp-cli which",
		"mcpmarket-pp-cli agent-context",
		"mcpmarket-pp-cli completion bash",
		"mcpmarket-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"mcpmarket-pp-cli recall",
		"mcpmarket-pp-cli learnings",
		"mcpmarket-pp-cli teach-pattern",
		"mcpmarket-pp-cli teach-lookup",
		"mcpmarket-pp-cli items list",
	}
