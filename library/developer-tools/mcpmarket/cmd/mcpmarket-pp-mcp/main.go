...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/developer-tools/mcpmarket/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("MCPMARKET_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "mcpmarket-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
