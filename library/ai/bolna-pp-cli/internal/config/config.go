...
type Config struct {
	...
	BolnaPpCliBearerAuth string          `toml:"pp_cli_bearer_auth"`
...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("BOLNA_PP_CLI_BEARER_AUTH"); v != "" {
		cfg.BolnaPpCliBearerAuth = v
		cfg.markEnvOverride("BolnaPpCliBearerAuth")
		cfg.AuthSource = "env:BOLNA_PP_CLI_BEARER_AUTH"
		cfg.CredentialSource = "env:BOLNA_PP_CLI_BEARER_AUTH"
	}
	...
	if v := os.Getenv("BOLNA_PP_CLI_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	...
	if v := strings.TrimSpace(os.Getenv("BOLNA_PP_CLI_BATCH_ID")); v != "" {
		cfg.TemplateVars["batch_id"] = v
	} else if verifyMode {
		cfg.TemplateVars["batch_id"] = "batch_id_placeholder"
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("BOLNA_PP_CLI_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "bolna-pp-cli-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	if c.BolnaPpCliBearerAuth != "" {
		if c.AuthSource == "" {
			c.AuthSource = "env:BOLNA_PP_CLI_BEARER_AUTH"
		}
		return "Bearer " + c.BolnaPpCliBearerAuth
	}
	if c.AccessToken != "" {
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		BolnaPpCliBearerAuth: c.BolnaPpCliBearerAuth,
	}
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	c.BolnaPpCliBearerAuth = creds.BolnaPpCliBearerAuth
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.BolnaPpCliBearerAuth = ""
	delete(c.envOverrides, "BolnaPpCliBearerAuth")
	c.updateFileConfigField("BolnaPpCliBearerAuth")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["BolnaPpCliBearerAuth"] {
			out.BolnaPpCliBearerAuth = c.fileConfig.BolnaPpCliBearerAuth
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "BolnaPpCliBearerAuth":
		c.fileConfig.BolnaPpCliBearerAuth = c.BolnaPpCliBearerAuth
	}
}
