...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  bolna-pp-cli-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"agent", "ambient-sounds", "assistants", "bolna-analytics", "compliance", "dispositions", "invoices", "keys", "knowledgebase", "phone-numbers", "prompt-library", "providers", "reports", "sip-trunks", "sub-accounts", "sub-accounts-all-usage", "user", "user-webhook-allowed-states", "violations", "voice-config", "voice-config-tts-voices"}
			totalSynced := 0
