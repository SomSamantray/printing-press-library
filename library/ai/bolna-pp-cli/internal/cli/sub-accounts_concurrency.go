...
func newSubAccountsConcurrencyCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagOrganizationId != "" {
				params["organization_id"] = formatCLIParamValue(flagOrganizationId)
			}
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "sub-accounts", false, path, params, nil, "", cmd.ErrOrStderr())
			if err != nil {
