...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/ai/bolna-pp-cli/internal/mcp"
...
func main() {
	...
	_ = os.Setenv("BOLNA_PP_CLI_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "bolna-pp-cli-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
