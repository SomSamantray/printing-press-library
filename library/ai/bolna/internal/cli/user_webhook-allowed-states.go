...
func newUserWebhookAllowedStatesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "user", false, path, params, nil, "", cmd.ErrOrStderr())
			if err != nil {
