...
type rootFlags struct {
	...
	// invocation. Mirrors the BOLNA_PP_CLI_NO_LEARN env var.
	noLearn bool
...
Run 'bolna-pp-cli-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.AddCommand(newBatchesCmd(flags))
	rootCmd.AddCommand(newDispositionsCmd(flags))
	rootCmd.AddCommand(newInboundCmd(flags))
	rootCmd.AddCommand(newKnowledgebaseCmd(flags))
	rootCmd.AddCommand(newPhoneNumbersCmd(flags))
	rootCmd.AddCommand(newProvidersCmd(flags))
	rootCmd.AddCommand(newSipTrunksCmd(flags))
	rootCmd.AddCommand(newSubAccountsCmd(flags))
	rootCmd.AddCommand(newUserCmd(flags))
	rootCmd.AddCommand(newViolationsCmd(flags))
	rootCmd.AddCommand(newVoiceConfigCmd(flags))
	...
	rootCmd.AddCommand(newAmbientSoundsPromotedCmd(flags))
	rootCmd.AddCommand(newAssistantsPromotedCmd(flags))
	rootCmd.AddCommand(newBolnaAnalyticsPromotedCmd(flags))
	rootCmd.AddCommand(newCallPromotedCmd(flags))
	rootCmd.AddCommand(newExecutionsPromotedCmd(flags))
	rootCmd.AddCommand(newPromptLibraryPromotedCmd(flags))
