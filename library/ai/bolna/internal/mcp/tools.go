...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/ai/bolna/internal/cli"
	...
	"github.com/mvanhorn/printing-press-library/library/ai/bolna/internal/mcp/cobratree"
		...
		"resources": []map[string]any{
			{
				...
				"endpoints":   []string{"create", "dashboard-list", "delete", "get", "legacy-dashboard-list", "list", "patch", "update"},
				"syncable":    true,
				"searchable":  true,
				"writable":    true,
			},
			{
				...
				"description": "Manage dispositions",
				"endpoints":   []string{"test-for-agent"},
				"writable":    true,
			},
			{
				"name":        "agent.execution",
				"description": "Manage execution",
				"endpoints":   []string{"agent-get"},
			},
			{
				"name":        "agent.executions",
				"description": "Manage executions",
				"endpoints":   []string{"agent"},
			},
			{
				"name":        "agent.prompt",
				"description": "Manage prompt",
				"endpoints":   []string{"agent-get"},
			},
			{
				"name":        "agent.stop",
				"description": "Manage stop",
				"endpoints":   []string{"agent-queued-calls"},
				"writable":    true,
			},
			{
				"name":        "ambient-sounds",
				"description": "Manage ambient sounds",
			...
			},
			{
				...
				"endpoints":   []string{"batch-create", "batch-delete", "batch-get"},
				"searchable":  true,
				"writable":    true,
			},
			{
				...
				"endpoints":   []string{"batch-list"},
			},
			{
				"name":        "batches.executions",
				"description": "Manage executions",
				"endpoints":   []string{"batch"},
			},
			{
				"name":        "batches.schedule",
			...
			{
				"name":        "bolna-analytics",
				"description": "Manage bolna analytics",
				"endpoints":   []string{"dashboard-list"},
				"syncable":    true,
			},
			{
				"name":        "call",
				"description": "Manage call",
				"endpoints":   []string{"make"},
				"writable":    true,
			},
			{
				"name":        "call.stop",
			...
			},
			{
				"name":        "dispositions",
				"description": "Manage dispositions",
				"endpoints":   []string{"bulk-create", "create", "delete", "get", "list", "update"},
				"syncable":    true,
				"searchable":  true,
				"writable":    true,
			},
			...
			},
			{
				...
				"endpoints":   []string{"execution-raw"},
			},
			{
				"name":        "get-current-price",
				"description": "Manage get current price",
				"endpoints":   []string{"price-get"},
				"searchable":  true,
			},
			{
				"name":        "inbound",
				"description": "Manage inbound",
				"endpoints":   []string{"setup", "unlink"},
				"writable":    true,
			},
			{
				"name":        "invoices",
			...
			},
			{
				...
				"endpoints":   []string{"buy", "delete", "list", "search"},
				"syncable":    true,
				"searchable":  true,
				"writable":    true,
			},
			{
				...
				"endpoints":   []string{"prompt-module-list"},
				"syncable":    true,
				"searchable":  true,
			},
			{
			...
			},
			{
				...
				"endpoints":   []string{"job-list"},
				"syncable":    true,
			},
			{
				"name":        "sip-trunks",
				"description": "Manage sip trunks",
				"endpoints":   []string{"add-number", "create", "delete", "get", "list", "numbers", "remove-number", "update"},
				"syncable":    true,
				"searchable":  true,
				"writable":    true,
			},
			{
				...
				"endpoints":   []string{"all-usage", "concurrency", "create", "delete", "list", "main-patch", "patch"},
				"syncable":    true,
				"searchable":  true,
				"writable":    true,
			},
			{
				"name":        "sub-accounts.usage",
				"description": "Manage usage",
				"endpoints":   []string{"subaccount"},
			},
			{
				"name":        "user",
				"description": "Manage user",
				"endpoints":   []string{"add-custom-model", "dashboard-bootstrap", "get", "list-models", "webhook-allowed-states"},
				"syncable":    true,
				"writable":    true,
			},
			{
				...
				"endpoints":   []string{"list", "submit"},
				"syncable":    true,
				"writable":    true,
			},
			{
				"name":        "voice-config",
				"description": "Manage voice config",
				"endpoints":   []string{"language-list", "voice-list", "voice-providers"},
				"syncable":    true,
				"searchable":  true,
			},
		},
