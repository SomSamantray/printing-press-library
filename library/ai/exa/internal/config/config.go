...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("EXA_API_KEY"); v != "" {
		cfg.ExaApiKey = v
		cfg.markEnvOverride("ExaApiKey")
		cfg.AuthSource = "env:EXA_API_KEY"
		cfg.CredentialSource = "env:EXA_API_KEY"
	}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("EXA_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "exa-pp-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	if c.ExaApiKey != "" {
		if c.AuthSource == "" {
			c.AuthSource = "env:EXA_API_KEY"
		}
		return "Bearer " + c.ExaApiKey
	}
	if c.AccessToken != "" {
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientSecret")
	c.ExaApiKey = ""
	delete(c.envOverrides, "ExaApiKey")
	c.updateFileConfigField("ExaApiKey")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["ExaApiKey"] {
			out.ExaApiKey = c.fileConfig.ExaApiKey
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "ExaApiKey":
		c.fileConfig.ExaApiKey = c.ExaApiKey
	}
}
