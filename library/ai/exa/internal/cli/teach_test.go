...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"exa-pp-cli auth login",
		"exa-pp-cli doctor",
		"exa-pp-cli help items",
		"exa-pp-cli sync",
		"exa-pp-cli profile list",
		"exa-pp-cli feedback list",
		"exa-pp-cli which",
		"exa-pp-cli agent-context",
		"exa-pp-cli completion bash",
		"exa-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"exa-pp-cli teach",
		"exa-pp-cli recall",
		"exa-pp-cli learnings",
		"exa-pp-cli teach-pattern",
		"exa-pp-cli teach-lookup",
		"exa-pp-cli items list",
	}
