...
large datasets as it has no memory pressure.`,
  ...
  exa-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  exa-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  exa-pp-cli export <resource> --format jsonl | jq '.id'`,
