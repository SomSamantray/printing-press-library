...
func newWebhooksCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  exa-pp-cli webhooks create --url https://example.com/resource",
		Annotations: map[string]string{"pp:endpoint": "webhooks.create", "pp:method": "POST", "pp:path": "https://api.exa.ai/websets/v0/webhooks"},
