...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/ai/keenable/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("KEENABLE_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "keenable-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
