...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/commerce/quickcommerce/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"quickcommerce-pp-cli auth login",
		"quickcommerce-pp-cli doctor",
		"quickcommerce-pp-cli help items",
		"quickcommerce-pp-cli sync",
		"quickcommerce-pp-cli profile list",
		"quickcommerce-pp-cli feedback list",
		"quickcommerce-pp-cli which",
		"quickcommerce-pp-cli agent-context",
		"quickcommerce-pp-cli completion bash",
		"quickcommerce-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"quickcommerce-pp-cli recall",
		"quickcommerce-pp-cli learnings",
		"quickcommerce-pp-cli teach-pattern",
		"quickcommerce-pp-cli teach-lookup",
		"quickcommerce-pp-cli items list",
	}
