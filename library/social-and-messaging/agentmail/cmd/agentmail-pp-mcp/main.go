...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/social-and-messaging/agentmail/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("AGENTMAIL_LEARN_SURFACE", "mcp")
	...
	case "http":
		if !isLoopbackAddr(*addr) {
			fmt.Fprintf(os.Stderr, "refusing unauthenticated MCP HTTP bind on non-loopback address %q; use 127.0.0.1 or :port\n", *addr)
			os.Exit(2)
		}
		httpSrv := server.NewStreamableHTTPServer(s)
		fmt.Fprintf(os.Stderr, "agentmail-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
